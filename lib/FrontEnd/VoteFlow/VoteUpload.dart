...
class VoteUploadView extends StatefulWidget {
  @override
  _VoteUploadViewState createState() => _VoteUploadViewState();
}

class _VoteUploadViewState extends State<VoteUploadView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const HeaderPrevious(text: "VOTE"),
              ...
              children: [
                ...
                ClearButton(
                  ...
                  onPressed: () {
                    ...
                    FirebaseComponents().setEachDataToFirestore('users/${GlobalVariables.userUUID}/votes/$documentID', data).then((result) {
                        
                        if (result) {

                          FirebaseComponents().setEachMediaToStorage('users/${GlobalVariables.userUUID}/votes/', 'users/${GlobalVariables.userUUID}/votes/$documentID', mediaData).then((result) {
