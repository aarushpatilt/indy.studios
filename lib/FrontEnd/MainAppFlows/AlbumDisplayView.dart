...
class AlbumDisplayView extends StatefulWidget {
  final String albumID;
  final String userID;

  AlbumDisplayView ({required this.albumID, required this.userID});

  @override
  _AlbumDisplayViewState createState() =>
      _AlbumDisplayViewState();
}

class _AlbumDisplayViewState extends State<AlbumDisplayView> {
  ...
  void initState() {
    ...
    _albumDataFuture = FirebaseComponents().getSpecificData(
      documentPath: '/users/${widget.userID}/albums/${widget.albumID}',
    ...
    _collectionDataDisplay = CollectionDataDisplay(  // create an instance of the new class
      collectionPath: '/users/${widget.userID}/albums/${widget.albumID}/collections',
              ...
              background: Stack(
                ...
                children: <Widget>[
                  FittedBox( // Added FittedBox
                    ...
                    child: FirstImageDisplay(documentPath: '/users/${widget.userID}/albums/${widget.albumID}'),  // Change BoxFit.cover to BoxFit.fill
                  ),
